...
// make style to the table
 ...
 ?>
    <table id='table-to-refresh' cellspacing='0' border="3" style="color: red;"><tr><th> code</th><th> name</th></tr><tbody id="rows">
    <tr><td><?php echo $row["name2"]; ?></td><td> <?php echo $row["email2"]; ?></td></tr></tbody>
   </table><?php
    } 
